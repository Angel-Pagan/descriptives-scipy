...
data.columns #column names from dataframe

print(data['Gender']) # print the data in a Gender column
...
""" columns can be forced to be treated as categorical by putting C("") around the variable "+ 1" forces the use of an intercept, "- 1" forces the use of no intercept """
